...
import { AdminBasicActions, AdminBasicState } from './types';

declare var abp: any;

export const initialState: AdminBasicState = { // day
...
function adminBasicReducer(// day
    state: AdminBasicState = initialState, //day
    action: AdminBasicActions // day
) {
    switch (action.type) {
...
export default adminBasicReducer;