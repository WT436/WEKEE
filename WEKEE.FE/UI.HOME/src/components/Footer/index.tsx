  ...
  return (
    <>
      <Helmet>
        <link
          rel="stylesheet"
          href="https://localhost:44324/StaticFiles/footer/footer.css"
        />
      </Helmet>
      ...
      <Row className="ftifmto">
        <Col className="ftifmtodt" span={5}>
          <ul className="ftspcl">
            ...
            <li>
              <a href="#">Hỗ trợ khách hàng: support@wekee.vn</a>
            </li>
            <li>
              <a href="#">Báo lỗi bảo mật: security@wekee.vn</a>
            </li>
          </ul>
        </Col>
        <Col className="ftifmtodt" span={5}>
      ...
      <Col className="ftcbAb">© 2021 - Design by WT436 - Wekee.com.vn</Col>
    </>
  );
};
