...
import {
    AuditOutlined, BellOutlined, CodeSandboxOutlined,
    CreditCardOutlined, DollarCircleOutlined, HomeOutlined,
...
class HeaderSupplier extends AppComponentBase<IHeaderSupplierProps, IHeaderSupplierState> {
                        ...
                        <Row>
                            ...
                            <Col span={8}>
                                <Menu mode="horizontal" className='hdfutmsttac'>
                                    ...
                                    <Badge count={10} className='hdfutmacim'>
