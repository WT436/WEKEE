...
import { CaretRightOutlined, HeartTwoTone, SearchOutlined, SyncOutlined } from '@ant-design/icons';
...
export default function Home(props: IHomeProps) {
    ...
    return (
        <>
                            ...
                            <Meta
                                ...
                                description={
                                    <div className='description-product'>
                                        ...
                                        <p className='description-product-promotion'><span>Mua 2 tặng 1</span><span>FreeShip</span><span>Giảm ₫25k</span></p>
            ...
            <Row style={{ margin: '20px 0' }}>
                <Card
                    title={<><SearchOutlined /> Tìm kiếm nổi bật.</>}
                    extra={
                        <Button size='small' type="link" block>
                            ...
                            <Card
                                ...
                                cover={
                                    <div className='search-highlights'>
                                        <a><img alt="example" src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" /></a>
                                        <a><img alt="example" src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" /></a>
                                        <a><img alt="example" src="https://os.alipayobjects.com/rmsportal/QBnOOoLaAfKPirc.png" /></a>
                                    </div>
                                }
                            >
                                <a href='#'><Meta style={{ padding: '5px 10px' }} title="Sách Kinh Tế" description="66 Sản Phẩm" /></a>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card
                            ...
                            >
                                <a><Meta style={{ padding: '5px 10px' }} title="Sách Kinh Tế" description="66 Sản Phẩm" /></a>
                            </Card>
                        </Col>
                        <Col span={6}>
                            <Card
