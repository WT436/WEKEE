...
import {
  makeCompleted, makeLoading, makeLoadingButton, makeLoadingTable, makePageIndex, makePageSize, makeResourceReads, makeTotalCount, makeTotalPages,
} from "../selectors";
import {
  Button, Card, Col, DatePicker, Form, Input, InputNumber, Modal, notification, Row, Select, Switch, Table, Tag, Tooltip,
} from "antd";
import {
  DeleteOutlined, EditOutlined, ExclamationCircleOutlined, PlusOutlined, RedoOutlined, RetweetOutlined, SearchOutlined,
